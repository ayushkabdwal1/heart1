        ...
        <div id="topbar" className="d-flex align-items-center fixed-top">
            <div className="container d-flex justify-content-between">
                <div className="contact-info d-flex align-items-center">
                    <FaEnvelope className='contact-icon'/> <a href="mailto:ujjalzaman@example.com">anmolsharma1923@gmail.com</a>
                    <FaPhoneAlt className='contact-icon'/> <a href="tel:+88 01751 040425">+91 8978232321</a> 
                </div>
                <div className="d-none d-lg-flex social-links align-items-center">
                    ...
                    <a href="https://github.com/Anmol71" target='_blank' rel="noreferrer" className=""><FaGithubSquare /></a>
